...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Taskick.Services.DataSource, Taskick", DataSource.class, __md_methods);
	}
	...
	public DataSource ()
	{
		...
		if (getClass () == DataSource.class)
			mono.android.TypeManager.Activate ("Taskick.Services.DataSource, Taskick", "", this, new java.lang.Object[] {  });
	}
